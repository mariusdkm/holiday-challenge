...
<div class='flex items-center flex-[1_0_370px]' date-rangepicker datepicker-format={datepickerFormat}>
  <div class='relative flex-[1_1_40%]'>
    ...
    <Input class='pl-10 peer' datepicker-format={datepickerFormat} id='date_start'
           name='start'
           placeholder=' '
           required
           type='text'
  ...
  <div class='relative flex-[1_1_40%]'>
    ...
    <Input
      class='pl-10 peer'
      datepicker-format={datepickerFormat} id='date_end' name='end'
      placeholder=' '
      required
      type='text'
